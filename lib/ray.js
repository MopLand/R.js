	...
	R.init.prototype = {
		...
		*/
		before : function( node, attr ){
			...
			//创建对象
			this.last = R.create( node, attr );

			//批量插入
			this.each( function( ){
				this.parentNode.insertBefore( this.last, this );
			});
		...
		*/
		after : function( node, attr ){
			...
			//批量插入
			this.each( function(){
				this.parentNode.insertBefore( this.last, this.nextSibling );
			});
