...
(function( win, doc ){
	...
	//文档根元素
	R.document = (function(){
		return (document.compatRde && document.compatRde !="BackCompat" && ! uat.toLowerCase().indexOf('webkit')>-1 ) ? document.documentElement : document.body;
	})();
		...
		inti.prototype = {
			...
			*/
			...
			mouse : function(){
				...
				if ( R.Browser.msie ) {
					var x = this.self.x + R.document.scrollLeft;
					var y = this.self.y + R.document.scrollTop;
				}else{
